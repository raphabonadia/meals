...
const dummyMeals = [
  ...
  Meal(
    ...
    duration: 45,
    ingredients: ['300g de corte de gado', '1 tomate', '1 pepino', '1 cebola', 'Ketchup', '2 pães de hambúrguer'],
    steps: [
  ...
  Meal(
    ...
    steps: [
      ...
      'Certifique-se de mexer a frigideira regularmente para que os schnitzels fiquem rodeados de óleo e o miolo fique ',
